...
use Cookie;
class RecruitNewsController extends Controller
{
    var $limit = 10;
    ...
    public function index(Request $request)
    {
        ...
        return view('backend.recruit.index', $data);
    }
    ...
    public function add(Request $request, $book_id = 0)
    {
        ...
        return view('backend.recruit.edit', $data);
    }
    ...
    public function detail(Request $request, $book_id = 0)
    {
        ...
        $data['book'] = $book;
        return view('backend.recruit.detail', $data);
    }
