...
<div class="main-wrap">
    ...
    <nav class="breadcrumbs is-full-width breadcrumbs-a" id="breadcrumb">
        <div class="inner ts-contain "><span><a href="/"><span>{{ __("messages.HOME") }}</span></a></span><span
                    class="delim">&raquo;</span><span class="current">@if(Session::get('locale') == 'vi') Đăng tin @else My Page  @endif</span></div>
    </nav>
    ...
    <div class="main ts-contain cf right-sidebar">
        <div class="ts-row">
            <div class="col-8 main-content">
                ...
                <h1 class="archive-heading"><span>@if(Session::get('locale') == 'vi') Đăng tin @else My Page  @endif</span></h1>
                <section class="block-wrap block-grid mb-none" data-id="8">
                    <div class="block-content">
                        ...
                        @endif
                        @if(isset($_GET['add_new']) && empty($msg))
                            <form class="information_search col-12" id="schedule-full-form" action="" method="post" enctype="multipart/form-data">
                                <div class="row mt-2">
                                    @csrf
                                    <div class="col-12 mt-3">
                                        <select required placeholder="Thể loại" class=" form-control" name="category_id" style="appearance:auto;padding: 8px;">
                                            @foreach($trades_menu as $menu)
                                                <option value="{{ $menu->id }}">@if(Session::get('locale') == 'vi') {{ $menu->name_vn }} @else {{ $menu->name_en }} @endif</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-12 mt-3">
                                        <input required value="" placeholder="Tiêu đề" class="input-block-level form-control" name="title_vn" type="text">
                                    </div>
                                    <div class="col-12 mt-3">
                                        <textarea placeholder="Nội dung" required name="content_vn" class="form-control summernote" rows="6"></textarea>
                                    </div>
                                    <div class="col-12 mt-3">
                                        <label for="files" class="btn" style="border: 1px solid #000">Hình ảnh</label>
                                        <input onchange="previewFile(this);" id="files" style="visibility:hidden;" required value="" placeholder="Hình ảnh" class="input-block-level form-control" name="img" type="file">
