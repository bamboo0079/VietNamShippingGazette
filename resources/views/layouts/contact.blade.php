...
<div class="main-wrap">
    ...
    <nav class="breadcrumbs is-full-width breadcrumbs-a" id="breadcrumb">
        <div class="inner ts-contain "><span><a href="/"><span>{{ __("messages.HOME") }}</span></a></span><span
                    class="delim">&raquo;</span><span class="current">@if(Session::get('locale') == 'vi') Liên Hệ @else Contact  @endif</span></div>
    </nav>
    ...
    <div class="main ts-contain cf right-sidebar">
        <div class="ts-row">
            <div class="col-8 main-content">
                ...
                <h1 class="archive-heading"><span>@if(Session::get('locale') == 'vi') Liên Hệ @else Contact  @endif</span></h1>
                    ...
                    <div class="block-content">
                        ...
                        <form class="information_search col-12" id="schedule-full-form" action="" method="post">
                            <div class="row mt-2">
                                ...
                                <div class="col-12 mt-3">
                                    <input required value="" placeholder="Tiêu đề" class="input-block-level form-control" name="title" type="text">
                                </div>
                                <div class="col-12 mt-3">
                                    <textarea required name="content" class="form-control" rows="6"></textarea>
                                </div>
                                <div class="col-6 mt-2 float-right" style="float:right; text-align:right;">
                                    <input class="btn btn-primary btn-medium pull-right" type="submit" name="yt0" value="Liên hệ">
                                </div>
                            </div>
                        </form>
                    </div>
