...
<head>
    ...
    <title>@if(Session::get('locale') == 'vi') {{ $category->name_vn }} @else {{ $category->name_en }} @endif</title>
    ...
    <meta property="og:title" content="@if(Session::get('locale') == 'vi') {{ $category->name_vn }} @else {{ $category->name_en }} @endif"/>
...
<div class="main-wrap">
    ...
    <nav class="breadcrumbs is-full-width breadcrumbs-a" id="breadcrumb">
        <div class="inner ts-contain "><span><a href="/"><span>{{ __("messages.HOME") }}</span></a></span><span
                    class="delim">&raquo;</span><span class="current">@if(Session::get('locale') == 'vi') {{ $category->name_vn }} @else {{ $category->name_en }} @endif</span></div>
    </nav>
    ...
    <div class="main ts-contain cf right-sidebar">
        <div class="ts-row">
                        ...
                        <div class="loop loop-grid loop-grid-base grid grid-3 md:grid-3 xs:grid-1">
                            @forelse($news as $new)
                                ...
                                <div class="content">
                                    ...
                                    <div class="post-meta post-meta-a has-below"><h2 class="is-title post-title"><a
                                                    href="{{ route('tin.tuc', $new->id) }}">@if(Session::get('locale') == 'vi') {{ $new->title_vn }} @else {{ $new->title_en }} @endif</a></h2>
                                        <span class="price"> <ins><span class="woocommerce-Price-amount amount"><bdi>Giá: {{ ($new->price)?$new->price:'Liên Hệ' }}</bdi></span></ins></span>
                                    </div>
                                </div>
                            </article>
                            @empty
            ...
            <aside class="col-3 main-sidebar has-sep" data-sticky="1">
...
<style>
    ...
    .block-content .l-post .content .price {
        margin-top: 7px;
        font-size: 15px;
        letter-spacing: .02em;
    }
    ...
    .block-content .l-post .content .price ins {
        text-decoration: none;
    }
    .block-content .l-post .content .price ins {
        background: 0 0;
    ...
    .block-content .l-post .content .price .amount {
        font-weight: 600;
    }
    .block-content .l-post .content .amount {
        color: #2ab391;
    }
</style>
</body>
