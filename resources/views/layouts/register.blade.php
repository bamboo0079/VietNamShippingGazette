...
<head>
    ...
    <meta property="og:title" content="Computing Archives - SmartMag ProMag"/>
    <meta property="og:url" content="https://smartmag.theme-sphere.com/pro-mag/category/example-2/"/>
    ...
    <link rel="alternate" type="application/rss+xml" title="SmartMag ProMag &raquo; Computing Category Feed"
          href="https://smartmag.theme-sphere.com/pro-mag/category/example-2/feed/"/>
    ...
    <link rel="alternate" type="application/json"
          href="https://smartmag.theme-sphere.com/pro-mag/wp-json/wp/v2/categories/3"/>
...
<body class="archive category category-example-2 category-3 right-sidebar has-lb has-lb-sm layout-normal elementor-default elementor-kit-802">
...
<div class="main-wrap">
    ...
    <nav class="breadcrumbs is-full-width breadcrumbs-a" id="breadcrumb">
        <div class="inner ts-contain "><span><a href="/"><span>{{ __("messages.HOME") }}</span></a></span><span
                    class="delim">&raquo;</span><span class="current">@if(Session::get('locale') == 'vi') Đăng Ký @else Register  @endif</span></div>
    </nav>
    ...
    <div class="main ts-contain cf right-sidebar">
        <div class="ts-row">
            <div class="col-8 main-content">
                ...
                <h1 class="archive-heading"><span>@if(Session::get('locale') == 'vi') Đăng Ký @else Register  @endif</span></h1>
                <section class="block-wrap block-grid mb-none" data-id="8">
                    <div class="block-content">
                        @if($msg)
                            <div class="row mt-2 mb-2" style="color: red;font-weight: bold;">
                                <div class="col-12">
                                    {{ $msg }}
                                </div>
                            </div>
                        @endif
                        <!--Full form-->
                        <form class="information_search col-12" id="schedule-full-form" action="" method="post">
                            <div class="row mt-2">
                                @csrf
                                <div class="col-12">
                                    <input required value="" placeholder="Họ tên" class="input-block-level form-control" name="name" type="text">
                                </div>
                                <div class="col-12 mt-2">
                                    <input required value="" placeholder="Email" class="input-block-level form-control" name="email" type="text">
                                </div>
                                <div class="col-12 mt-2">
                                    <input required value="" placeholder="Điện thoại" class="input-block-level form-control" name="phone" type="text">
                                </div>
                                <div class="col-12 mt-2">
                                    <input required value="" placeholder="Mật khẩu" class="input-block-level form-control" name="password" type="password">
                                </div>
                                <div class="col-12 mt-2">
                                    <input required value="" placeholder="Xác nhận mật khẩu" class="input-block-level form-control" name="confirm_password" type="password">
                                </div>
                                <div class="col-6 mt-2 float-right" style="float:right; text-align:right;">
                                    <input class="btn btn-primary btn-medium pull-right" type="submit" name="yt0" value="Đăng Ký">
                                </div>
                            </div>
                        </form>
                    </div>
...
<script type="application/ld+json">{"@context
    ...
    ":"https:\/\/smartmag.theme-sphere.com\/pro-mag\/category\/example-2\/","name":"Category: &quot;Computing&quot;"}}]}
</script>
...
<!-- Debloat Remove CSS Saved: 222880 bytes. -->