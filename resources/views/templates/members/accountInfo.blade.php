...
@section('content')
    <style type="text/css">
        .account-info-group li {
            line-height: 50px;
        }
        .account-info-group li strong{
            padding-left: 5px;
        }
        .account-info-group {
            margin-bottom: 20px;
    ...
    <div class="main ts-contain cf right-sidebar spc-alp-main" style="transform: none;">
        <div class="ts-row" style="transform: none;">
            <div class="col-8 main-content">
                ...
                <ul class="list-group list-group-flush account-info-group">
                    <li class="list-group-item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                            <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
                            <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z"/>
                        </svg>
                        <strong> {{ __("messages.FULL_NAME") }}: </strong> {{ $name }}
                    </li>
                    <li class="list-group-item">
                        ...
                        <strong>{{ __("messages.Email") }}: </strong> {{ $email }}</li>
                    <li class="list-group-item">
                        ...
                        <strong> {{ __("messages.PHONE_NUMBER") }}: </strong> {{ $phone }}
                    </li>
                    <li class="list-group-item">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bag" viewBox="0 0 16 16">
                            <path d="M8 1a2.5 2.5 0 0 1 2.5 2.5V4h-5v-.5A2.5 2.5 0 0 1 8 1zm3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4h-3.5zM2 5h12v9a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V5z"/>
                        </svg>
                        <strong> {{ __("messages.PASSWORD_TITLE") }}: </strong> *******</li>
                </ul>

                <button type="button" class="btn btn-primary update-info">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-counterclockwise" viewBox="0 0 16 16">
                        <path fill-rule="evenodd" d="M8 3a5 5 0 1 1-4.546 2.914.5.5 0 0 0-.908-.417A6 6 0 1 0 8 2v1z"></path>
                        <path d="M8 4.466V.534a.25.25 0 0 0-.41-.192L5.23 2.308a.25.25 0 0 0 0 .384l2.36 1.966A.25.25 0 0 0 8 4.466z"></path>
                    </svg>
                   <a href="{{ route("update.account") }}"> {{ __("messages.CHANGE_INFO") }}</a>
                </button>
            </div>
