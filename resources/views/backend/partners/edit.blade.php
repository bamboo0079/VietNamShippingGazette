    ...
    <div id="content">
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-primary">{{ __("Thêm đối tác") }}</h1>
                    ...
                    <form action="{{ route('admin.partner.process') }}" enctype="multipart/form-data" method="post" novalidate class="needs-validation">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="input-field col-sm-9">
                                    <input id="link" type="text" placeholder="Đường link" class="input-space form-control @error('link') is-invalid @enderror" name="link" value="{{ old('link') }}" autofocus>
                                    <div class="invalid-feedback">{!! __("Vui lòng nhập") !!}</div>
                                </div>
                            </div>
                        </div>
