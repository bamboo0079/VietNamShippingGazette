                    ...
                    <form action="{{ route('admin.partner.process') }}" enctype="multipart/form-data" method="post" novalidate class="needs-validation">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="input-field col-sm-9">
                                    <input id="name" type="text" placeholder="Đối tác" class="input-space form-control @error('name') is-invalid @enderror" required name="title_vn" value="{{ $book->title_vn }}" autofocus>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="input-field col-sm-9">
                                    <input id="name" type="text" placeholder="Đối tác" class="input-space form-control @error('name') is-invalid @enderror" required name="title_en" value="{{ $book->title_en }}" autofocus>
                                    <div class="invalid-feedback">{!! __("Vui lòng nhập") !!}</div>
                                </div>
                            </div>
                        </div>
