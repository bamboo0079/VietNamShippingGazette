    ...
    <div id="content">
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-primary">{{ __("Loại danh mục") }}</h1>
                <a href="{{ route('admin.category') }}" class="d-sm-inline-block btn btn-primary btn-add"><i class="fas fa-angle-left"></i> Quay lại</a>
            </div>
            <!-- End Heading -->
            <!-- DataTales Example -->
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary">{{ __("Loại danh mục") }}</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.category.process') }}" enctype="multipart/form-data" method="post" novalidate class="needs-validation">
                        @csrf
                        ...
                        <div class="form-group">
                            <div class="row">
                                <label class="control-label col-sm-3 text-right">Tên danh mục<span class="required-label">（<small>*</small>）</span></label>
                        ...
                        <div class="buttons-set text-center">
                            ...
                            <a href="{{ route('admin.category') }}" class="btn btn-light"><i class="fa fa-reply"></i>Hủy bỏ</a>
                        </div>
                    </form>
                </div>
            </div>
