        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary">{{ __("Thêm tin tức") }}</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.new.process') }}" enctype="multipart/form-data" method="post" novalidate class="needs-validation">
                        ...
                        <div class="form-group @if(isset($book->category_id) && !in_array($book->category_id, array(4,5,6))) hidden @endif" >
                            <div class="row">
                        ...
                        <div class="buttons-set text-center">
                            ...
                            <a href="{{ route('admin.news') }}" class="btn btn-light"><i class="fa fa-reply"></i>Hủy bỏ</a>
                        </div>
                    </form>
                </div>
            </div>
