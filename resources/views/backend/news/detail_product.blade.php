    ...
    <div id="content">
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <a href="{{ route('admin.new.product') }}" class="d-sm-inline-block btn btn-primary btn-add"><i class="fas fa-angle-left"></i> Quay lại</a>
            </div>
            <!-- End Heading -->
            <!-- DataTales Example -->
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.product.new.process') }}" enctype="multipart/form-data" method="post" novalidate class="needs-validation">
                        @csrf
                        @if(isset($book->id))
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="input-field col-sm-9">
                                    <input id="title_vn" type="text" placeholder="Tiêu đề tiếng việt" class="input-space form-control @error('title_vn') is-invalid @enderror" required name="title_vn" value="{{ $book->title_vn }}" autofocus>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="input-field col-sm-9">
                                    <input id="title_en" type="text" placeholder="Tiêu đề tiếng anh" class="input-space form-control @error('title_en') is-invalid @enderror" required name="title_en" value="{{ $book->title_en }}" autofocus>
                                    <div class="invalid-feedback">{!! __("Vui lòng nhập") !!}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group self-process">
                            <div class="row">
                                ...
                                <div class="input-field col-sm-9">
                                    <textarea id="content_vn" rows="6" name="content_vn" placeholder="Nội dung tiếng việt" class="summernote input-space form-control" @error('content_vn') is-invalid @enderror required>{{ $book->content_vn }}</textarea>
                                    <div class="invalid-feedback">{!! __("Vui lòng nhập") !!}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group self-process">
                            <div class="row">
                                ...
                                <div class="input-field col-sm-9">
                                    <textarea id="content_en" rows="6" name="content_en" placeholder="Nội dung tiếng anh" class="summernote input-space form-control" @error('content_en') is-invalid @enderror required>{{ $book->content_en }}</textarea>
                                    <div class="invalid-feedback">{!! __("Vui lòng nhập") !!}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <label class="control-label col-sm-3 text-right">Giá</label>
                                <div class="input-field col-sm-9">
                                    <input id="price" type="text" placeholder="Giá" class="input-space form-control @error('price') is-invalid @enderror" name="price" value="{{ $book->price }}" autofocus>
                                    <div class="invalid-feedback">{!! __("Vui lòng nhập") !!}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group hidden @if(isset($book->category_id) && !in_array($book->category_id, array(4,5,6))) hidden @endif" >
                            <div class="row">
                        ...
                        <div class="buttons-set text-center">
                            ...
                            <a href="{{ route('admin.new.product') }}" class="btn btn-light"><i class="fa fa-reply"></i>Hủy bỏ</a>
                        </div>
                    </form>
                </div>
            </div>
