                    ...
                    <form action="{{ route('admin.product.new.process') }}" enctype="multipart/form-data" method="post" novalidate class="needs-validation">
                        ...
                        <div class="form-group self-process">
                            <div class="row">
                                ...
                                <div class="input-field col-sm-9">
                                    <textarea id="content_vn" rows="6" name="content_vn" placeholder="Nội dung tiếng việt" class="summernote input-space form-control" @error('content_vn') is-invalid @enderror required>{{ old('content_vn') }}</textarea>
                                    <div class="invalid-feedback">{!! __("Vui lòng nhập") !!}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group self-process">
                            <div class="row">
                                ...
                                <div class="input-field col-sm-9">
                                    <textarea id="content_en" rows="6" name="content_en" placeholder="Nội dung tiếng anh" class="summernote input-space form-control" @error('content_en') is-invalid @enderror required>{{ old('content_en') }}</textarea>
                                    <div class="invalid-feedback">{!! __("Vui lòng nhập") !!}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="input-field col-sm-9">
                                    <input id="price" type="text" placeholder="Giá" class="input-space form-control @error('price') is-invalid @enderror" name="price" value="{{ old('price') }}" autofocus>
                                    <div class="invalid-feedback">{!! __("Vui lòng nhập") !!}</div>
                                </div>
                            </div>
                        </div>
