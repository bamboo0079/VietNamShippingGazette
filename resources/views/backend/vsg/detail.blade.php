            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.new.process') }}" enctype="multipart/form-data" method="post" novalidate class="needs-validation">
                        ...
                        <div class="form-group self-process hidden">
                            <div class="row">
                                <label class="control-label col-sm-3 text-right">Nội dung tiếng việt<span class="required-label">（<small>*</small>）</span></label>
                                <div class="input-field col-sm-9">
                                    <textarea id="content_vn" rows="6" name="content_vn" placeholder="Nội dung tiếng việt" class="summernote input-space form-control" @error('content_vn') is-invalid @enderror>{{ $book->content_vn }}</textarea>
                                    <div class="invalid-feedback">{!! __("Vui lòng nhập") !!}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group self-process hidden">
                            <div class="row">
                                ...
                                <div class="input-field col-sm-9">
                                    <textarea id="content_en" rows="6" name="content_en" placeholder="Nội dung tiếng anh" class="summernote input-space form-control" @error('content_en') is-invalid @enderror>{{ $book->content_en }}</textarea>
                                    <div class="invalid-feedback">{!! __("Vui lòng nhập") !!}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="buttons-set text-center">
                            ...
                            <a href="{{ route('admin.vsg.news') }}" class="btn btn-light"><i class="fa fa-reply"></i>Hủy bỏ</a>
                        </div>
                    </form>
                </div>
            </div>
