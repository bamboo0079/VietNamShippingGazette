        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary">{{ __("Thêm tin tức VSG") }}</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.vsg.new.process') }}" enctype="multipart/form-data" method="post" novalidate class="needs-validation">
                                ...
                                <div class="input-field col-sm-9">
                                    <select id="category_id" name="category_id" class="form-control">
                                        ...
                                        @foreach($categories as $category)
                                            <option @if($category->id == 2) selected @endif value="{{ $category->id }}">{{ $category->name_vn }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-group self-process hidden">
                            <div class="row">
                                ...
                                <div class="input-field col-sm-9">
                                    <textarea id="content_vn" rows="6" name="content_vn" placeholder="Nội dung tiếng việt" class="summernote input-space form-control" @error('content_vn') is-invalid @enderror>{{ old('content_vn') }}</textarea>
                                    <div class="invalid-feedback">{!! __("Vui lòng nhập") !!}</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group self-process hidden">
                            <div class="row">
                                ...
                                <div class="input-field col-sm-9">
                                    <textarea id="content_en" rows="6" name="content_en" placeholder="Nội dung tiếng anh" class="summernote input-space form-control" @error('content_en') is-invalid @enderror>{{ old('content_en') }}</textarea>
                                    <div class="invalid-feedback">{!! __("Vui lòng nhập") !!}</div>
                                </div>
                            </div>
                        </div>
