    ...
    <div id="content">
        <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-primary">{{ __("Thêm sản phẩm vào kho") }}</h1>
                <a href="{{ route('admin.wherehouse') }}" class="d-sm-inline-block btn btn-primary btn-add"><i class="fas fa-angle-left"></i> Quay lại</a>
            </div>
            <!-- End Heading -->
            <!-- DataTales Example -->
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary">{{ __("Thêm sản phẩm vào kho") }}</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('admin.wherehouse.process') }}" enctype="multipart/form-data" method="post" novalidate class="needs-validation">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="input-field col-sm-9">
                                    <input id="name" type="text" placeholder="Rau muống" class="form-control @error('name') is-invalid @enderror" required name="name" value="{{ old('name') }}" autofocus>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="input-field col-sm-9">
                                    <input id="qty" type="text" placeholder="Số lượng" class="form-control @error('qty') is-invalid @enderror" required name="qty" value="{{ old('qty') }}" autofocus>
                                    <div class="invalid-feedback">{!! __("Vui lòng nhập") !!}</div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="input-field col-sm-9">
                                    <input id="unit" type="text" placeholder="kg, ml, bao, bó ..." class="form-control @error('unit') is-invalid @enderror" required name="unit" value="{{ old('unit') }}" autofocus>
                                    <div class="invalid-feedback">{!! __("Vui lòng nhập") !!}</div>
                                </div>
                            </div>
                        </div>
