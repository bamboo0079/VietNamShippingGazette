                        ...
                        <div class="form-group input-process">
                            <div class="row">
                                ...
                                <div class="input-field col-sm-9">
                                    ...
                                    <img id="previewImg" src="@if(isset($img1)) {{ $img1 }} @else https://upload.wikimedia.org/wikipedia/commons/c/ca/1x1.png @endif " alt="Placeholder">
                                </div>
                            </div>
                        </div>
                        <div class="form-group input-process">
                            <div class="row">
                                ...
                                <div class="input-field col-sm-9">
                                    ...
                                    <img id="previewImg2" src="@if(isset($img2)) {{ $img2 }} @else https://upload.wikimedia.org/wikipedia/commons/c/ca/1x1.png @endif " alt="Placeholder">
                                </div>
                            </div>
                        </div>
                        <div class="form-group input-process">
                            <div class="row">
                                ...
                                <div class="input-field col-sm-9">
                                    ...
                                    <img id="previewImg3" src="@if(isset($img3)) {{ $img3 }} @else https://upload.wikimedia.org/wikipedia/commons/c/ca/1x1.png @endif " alt="Placeholder">
                                </div>
                            </div>
                        </div>
